...
async function getGeneralEquipment(request) {
  ...
  return Response.json({
    ...
    items: filtered.map(({id, name, grade, icon, group, category: itemCategory, equipType}) => ({id, name, grade, equipType: equipType || "", category: itemCategory || category, family: category, icon: icon || (group === "Weapon" ? `/equipment-icons/${id}.webp` : equipmentArt[category])})),
